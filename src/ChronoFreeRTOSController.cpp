 ...
 * -----
 * Last Modified: Tuesday, 4th February 2025 3:30:12 pm
...
namespace Omega
{
    namespace Chrono
    {
        ...
        void FreeRTOS::start(Duration update_period, Duration in_duration) noexcept
        {
            ...
            LOGD("duration in ms: %d", in_duration.get_in_msecs());
